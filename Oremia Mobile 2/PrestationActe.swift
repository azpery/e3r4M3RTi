    ...
    class func prestationToFormattedOutput(patient:patients,prestations:[PrestationActe]) -> NSString?{
        do{
            ...
            for presta  in prestations {
                vretour[presta.nom] = ["Coefficient":presta.coefficient,"Description":presta.description,"LettreCle":presta.lettreCle,"Montant":presta.montant,"dateActe":presta.dateActe,"Image":presta.image,"NumDent":presta.numDent]
            }
