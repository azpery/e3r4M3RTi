...
- (void) showClearButton {
    ...
    [self setInternalDate:self.currentDay.date];
    [self setCurrentDay:self.currentDay];
    [self setDate:self.currentDay.date];
    [self.currentDay setEnabled:YES];
